...
const replaceTemplate = (temp, product) => {
  // here temp is the html code and the product is the elements of the api(data.json) file.
  // here we are replacing the %PRODUCTNAME% which is in the template-cart.html to actual productName from the data.json file.
  ...
  output = output.replace(/{%ID%}/g, product.id); // this id i am using in the template-card.html[href="/product?id={%ID%}"]
